...
//            () -> MazeFactory.getLarge1wMazeFromFile(3),
//            () -> MazeFactory.getLarge1wMazeFromFile(4),
//            () -> MazeFactory.getLarge1wMazeFromFile(5),
//            () -> MazeFactory.getLarge1wMazeFromFile(6),
//            () -> MazeFactory.getLarge1wMazeFromFile(7),
//            () -> MazeFactory.getLarge1wMazeFromFile(8),
//            () -> MazeFactory.getLarge1wMazeFromFile(9),
//            () -> MazeFactory.getLarge1wMazeFromFile(10),
//            () -> MazeFactory.getLarge1wMazeFromFile(11),
//            () -> MazeFactory.getLarge1wMazeFromFile(12),
//            () -> MazeFactory.getHuge1wMazeFromFile(4),
//            () -> MazeFactory.getHuge1wMazeFromFile(5),
//            () -> MazeFactory.getHuge1wMazeFromFile(6),
//            () -> MazeFactory.getHuge1wMazeFromFile(7)
//    );
//    public static final List<Supplier<Maze>> MAZES = List.of(
//            () -> MazeFactory.getDungeon(SMALL),
//            () -> MazeFactory.getDungeon(SMALL),
...
//            () -> MazeFactory.getDungeon(LARGE),
//            () -> MazeFactory.getHugeDungeonMazeFromFile(1),
//            () -> MazeFactory.getHugeDungeonMazeFromFile(2),
//            () -> MazeFactory.getHugeDungeonMazeFromFile(3),
//            () -> MazeFactory.getHugeDungeonMazeFromFile(4),
//            () -> MazeFactory.getHugeDungeonMazeFromFile(5),
//            () -> MazeFactory.getHugeDungeonMazeFromFile(6),
//            () -> MazeFactory.getHugeDungeonMazeFromFile(7),
//            () -> MazeFactory.getHugeDungeonMazeFromFile(8),
//            () -> MazeFactory.getHugeDungeonMazeFromFile(9),
//            () -> MazeFactory.getHugeDungeonMazeFromFile(10),
//            () -> MazeFactory.getHugeDungeonMazeFromFile(11),
//            () -> MazeFactory.getHugeDungeonMazeFromFile(12),
